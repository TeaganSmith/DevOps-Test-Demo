...
# Clone your app
cd /home/ubuntu
git clone https://github.com/TeaganSmith/DevOps-Test-Demo.git
chown -R ubuntu:ubuntu DevOps-Test-Demo
...
[Service]
User=ubuntu
WorkingDirectory=/home/ubuntu/DevOps-Test-Demo
ExecStart=/usr/bin/python3 /home/ubuntu/DevOps-Test-Demo/app.py
Restart=always
